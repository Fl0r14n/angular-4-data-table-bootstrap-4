...
export class Demo1Component {
  ...
  rowClick(rowEvent: DataTableRowEvent<Person>): void {
    console.log('Clicked: ' + rowEvent.row.item.name);
  }

  rowDoubleClick(rowEvent: DataTableRowEvent<Person>): void {
  ...
  cellClick(cellEvent: DataTableCellEvent<Person>): void {
